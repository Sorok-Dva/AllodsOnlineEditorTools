Global( "TEST_NAME", "SmokeTest.WorldLootMobs; author: Liventsev Andrey, date: 02.09.08" )
...
function SummonNext()
	...
	elseif CUR_MOB_INDEX <= GetTableSize( MOB_TABLE ) then
