Global( "TEST_NAME", "AL2, Q12_30. author: Grigoriev Anton; date: 23.12.2008; Task 50588" )
...
Global( "DEV2_NAME", nil )
Global( "DEV2_COUNT", nil )
...
function Step2()
	local devCoord = GetNoLootDevCoords( MOB_LIST, DEV2_NAME, TEST_NAME )
	UseDevs( DEV2_NAME, devCoord, DEV2_COUNT, 10000, ReturnTrue, StepLast, ErrorFunc )
end
...
function Init()
	...
	DEV2_NAME = developerAddon.GetParam( "Dev2Name" )
	DEV2_COUNT = tonumber( developerAddon.GetParam( "Dev2Count" ))
