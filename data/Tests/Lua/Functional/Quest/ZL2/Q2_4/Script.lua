Global( "TEST_NAME", "ZL2, Q2_4. author: Grigoriev Anton; date: 17.12.2008; Task 41636" )
...
Global( "LOOT4_NAME", nil )
Global( "LOOT4_COUNT", nil )
...
function Step2()
	LootMobs( MOB_LIST, LOOT2_NAME, LOOT2_COUNT, Step3, ErrorFunc )
end

function Step3()
	LootMobs( MOB_LIST, LOOT3_NAME, LOOT3_COUNT, Step4, ErrorFunc )
end

function Step4()
	LootMobs( MOB_LIST, LOOT4_NAME, LOOT4_COUNT, StepLast, ErrorFunc )
end
...
function Init()
	...
	LOOT4_NAME = developerAddon.GetParam( "Loot4Name" )
    LOOT4_COUNT = tonumber( developerAddon.GetParam( "Loot4Count" ))
