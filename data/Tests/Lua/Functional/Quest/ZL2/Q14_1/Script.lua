Global( "TEST_NAME", "ZL2, Q14_1. author: Grigoriev Anton; date: 08.12.2008; Task 41636" )
...
function Step3()
	...
	KillMobs( QUEST_NAME, MOB3_NAME, mobCoords, Step4, ErrorFunc )
end

function Step4()
	local mobCoords = GetMobCoords( MOB_LIST, MOB4_NAME, TEST_NAME )
	KillMobs( QUEST_NAME, MOB4_NAME, mobCoords, StepLast, ErrorFunc )
end
...
function Init()
	...
	MOB_NAME4 = developerAddon.GetParam( "MobName4" )
