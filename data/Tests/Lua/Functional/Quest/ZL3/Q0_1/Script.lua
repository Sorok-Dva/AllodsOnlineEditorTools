Global( "TEST_NAME", "ZL3, Q0_1. author: Grigoriev Anton; date: 05.12.2008; Task 49575" )
...
function Step1()
    qaMission.AvatarSetPos( POINT_COORD )
	StartTimer ( 5000, StepLast )
end
...
function Init()
	...
	local pos = {
			X = tonumber( developerAddon.GetParam( "PlaceX" )),
			Y = tonumber( developerAddon.GetParam( "PlaceY" )),
			Z = tonumber( developerAddon.GetParam( "PlaceZ" ))
	}
	POINT_COORD = ToStandartCoord( pos )
