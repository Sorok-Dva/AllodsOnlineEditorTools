Global( "TEST_NAME", "AL1, quest4_4. author: Liventsev Andrey; date: 10.07.2008" )
...
function Step1()
	local mobCoords = GetMobCoords( MOB_LIST, MOB_NAME, TEST_NAME )
	KillMobs( QUEST_NAME, MOB_NAME, mobCoords, StepLast, ErrorFunc )
end
