Global( "TEST_NAME", "SmokeTest.Vendor BuyBack; author: Liventsev Andrey, date: 10.10.08, task ?" )
...
function SellingItem()
	SellItem( VENDOR_NAME, ITEM_NAME, 1, ButItemBack, ErrorFunc )
end

function ButItemBack()
	BuyItem( VENDOR_NAME, ITEM_NAME, 1, Done, ErrorFunc, true )
end
